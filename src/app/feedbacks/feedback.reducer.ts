...
// smoothly
export const feedbacks = (state: any = [], {type, payload}) => {

  // DEBUG
  console.log('Feedback reducer hit! type: ');
  console.log(type);
  console.log('payload: ');
  console.log(payload);
  console.log('state: ');
  ...
  switch (type) {
    ...
    case 'UPDATE_FEEDBACK':
      return state.map(feedback => {
        ...
        return feedback._id === payload._id
          ? Object.assign({}, feedback, payload) : feedback;
      });
